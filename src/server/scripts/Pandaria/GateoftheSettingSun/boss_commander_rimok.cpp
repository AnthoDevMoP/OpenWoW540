...
public:
    ...
    {
        return new boss_commander_rimok (creature);
    }

    struct boss_commander_rimokAI : public ScriptedAI
    {
        boss_commander_rimokAI(Creature* creature) : ScriptedAI(creature)
        {
